      ...
      <div className="mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 w-full md:w-80 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
          />
        </div>
      </div>
